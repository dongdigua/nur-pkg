...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url = "https://src.fedoraproject.org/rpms/nvi/raw/f33/f/nvi-13-widechar_horrors.patch";
      sha256 = "sha256-OmllhiefvlmUoHsgDTeRUKywTP/e6tHnRIaj3n5cC4M=";
    })

    (fetchpatch {
      url = "https://src.fedoraproject.org/rpms/nvi/raw/f33/f/nvi-19-include_term_h.patch";
      sha256 = "sha256-2YqHwWwFOZUZrZQujfZ7L5D/d8GSnU6cMnhSFPk+Iwg=";
    })

    (fetchpatch {
      url = "https://src.fedoraproject.org/rpms/nvi/raw/f33/f/nvi-27-support_C_locale.patch";
      sha256 = "sha256-1Yry+54JQ21FJFUAAaBF6puL3DLK8uTStzJ0SnuYxlo=";
    })
  ];
  ...
  meta = with lib; {
    description = "The Berkeley Vi Editor with UTF-8 support";
